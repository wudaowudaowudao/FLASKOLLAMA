...
class PDFQuerySystem:
    def __init__(self, baichuan_api_key, zhipuai_api_key):
        ...
        # self.llm = ChatZhipuAI(model="glm-4-0520", temperature=0.2)
...
def main():
    ...
    db_path = "E:\\PycharmProjects\\FlaskOllama\\data\\vector_json_db\\2025-04-16"  # 向量数据库的路径
